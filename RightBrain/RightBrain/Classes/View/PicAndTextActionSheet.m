...
-(id) initWithList:(NSArray *)list title:(NSString *)title{
    if (self = [super init]) {
        ...
        _tableview = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth, 64*[list count]+44) style:UITableViewStylePlain];
        _tableview.dataSource = self;
        _tableview.delegate = self;
        _tableview.scrollEnabled = NO;
        _tableview.layer.cornerRadius = 5;
        
        _customerView = [[UIView alloc] initWithFrame:CGRectMake(0, ScreenHeight, ScreenWidth, CGRectGetHeight(_tableview.frame))];
